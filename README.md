...
3. ***Consumer:*** Этот сервис должен слушать сообщения из NATS, обрабатывать их через сервис text processing, собирать сообщения во внутреннем хранилище и подсчитывать количество повторений каждого запроса. К сервису следует добавить handler, который будет возвращать топ-k запросов.
...
***Важно:*** В ходе выполнения проекта необходимо продемонстрировать навыки работы с оптимизацией.
